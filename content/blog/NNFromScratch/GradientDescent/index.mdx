...
\nabla f = 
\begin{bmatrix}
\frac{\partial f}{\partial x} \\[7pt]
\frac{\partial f}{\partial y} \\[7pt]
...
\nabla f(x_0, y_0, z_0, ...) = 
\begin{bmatrix}
\frac{\partial f}{\partial x} (x_0, y_0, z_0, ...)\\[7pt]
\frac{\partial f}{\partial y} (x_0, y_0, z_0, ...)\\[7pt]
...
- $\alpha$ is a scalar for the gradient to decrease how big of a step we take
